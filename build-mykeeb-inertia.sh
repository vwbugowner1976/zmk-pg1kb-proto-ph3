...
RUNTIME_COMBO_DIR="$(module_path zmk-feature-runtime-combo \
    ...
    "runtime-combo module not found. Run: cd $WEST_TOPDIR && west update zmk-feature-runtime-combo"
JP_KEYS_DIR="$(module_path zmk-behavior-jpkeysforuslayout \
    "$ENV_ROOT/projects/zmk-behavior-jpkeysforuslayout" \
    "$WEST_TOPDIR/modules/zmk-behavior-jpkeysforuslayout")" || fail \
    "JPKeysForUSLayout module not found. Run: cd $WEST_TOPDIR && west update zmk-behavior-jpkeysforuslayout"
...
EXPECTED_RUNTIME_COMBO_SHA="150c67af9f80d064efdf15c928bca9204b2302a7"
EXPECTED_JP_KEYS_SHA="d171f1acf07fa107080b48cfd101fa60a182b017"
...
ACTUAL_JP_KEYS_SHA="$(git -C "$JP_KEYS_DIR" rev-parse HEAD)"
...
[[ "$ACTUAL_JP_KEYS_SHA" == "$EXPECTED_JP_KEYS_SHA" ]] || fail \
  "JPKeysForUSLayout is $ACTUAL_JP_KEYS_SHA; expected $EXPECTED_JP_KEYS_SHA"
...
EXTRA_MODULES="$PROJECT_DIR;$INERTIA_DIR;$PAW3222_DIR;$PMW3610_DIR;$NON_LIPO_DIR;$CUSTOM_SETTINGS_DIR;$RUNTIME_INPUT_DIR;$RUNTIME_COMBO_DIR;$JP_KEYS_DIR;$PROSPECTOR_DIR"
